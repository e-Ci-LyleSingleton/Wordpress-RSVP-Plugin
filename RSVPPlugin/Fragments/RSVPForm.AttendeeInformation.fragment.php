...
<label>
	...
	<br><label>
	<input class="w3-radio" name="mealOptions" type="radio" value="kids" <?php isset($mealOptions) && $mealOptions == "kids" && print( "checked" )?> /> Under 16's meal</label>
</p>
...
<label>
	...
	<br><textarea class="w3-input w3-animate-input" style="width: 50%; height: 95px;" name="otherDietaryReqs" placeholder="Please describe any other dietary requirements so that we may pass them on for catering purposes"><?php isset($otherDietaryReqs) && print( $otherDietaryReqs )?></textarea>
	</p>