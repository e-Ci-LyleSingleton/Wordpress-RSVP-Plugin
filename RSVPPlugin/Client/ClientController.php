...
if ( !class_exists( 'ClientController' ) ) {
    ...
    class ClientController extends PageRenderer
    {
        ...
        function __construct( $pluginConfiguration )
        {
            ...
            $this->subController = new ClientSearch( $this->config );
        }

        
        public function OnPageActivate()
        {
            $this->renderContext = $_POST;
        }
        ...
        public function Render()
        {
            ...
            return $this->subController->Render();
